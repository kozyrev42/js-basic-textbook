...
let num311 = 0;
let num312 = num311++; // в переменную num312 запишется 0
// console.log(num312); // выведет 0
// console.log(num311); // выведет 1 - переменная num311 поменялась после записи в num312


// Неточные вычисления
let a32 = 0.1 + 0.2;
// console.log(a32); // выведет 0.30000000000000004
// метод toFixed, выполняющий округление до заданного знака в дробной части.
// console.log(a32.toFixed(2)); // выведет '0.30' - строку
